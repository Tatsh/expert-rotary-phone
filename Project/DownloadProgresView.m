...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self != nil) {
        ...
        // Message label: full dialog width minus 30pt inset on both sides, 24pt tall.
        // x = 0.0 (exact: movs r2,#0x0 at 0xde45e), y = 0.0, w = dialog.w - 30 (exact),
        // h = 24.0 (0x41c00000, exact). -layout: recenters it anyway.
        ...
        // Progress bar (Bar style). All exact: x = 25 (0x41c80000), y = dialog.h/2 + 35
        // (DAT_000de62c = 0x420c0000 = 35.0), w = dialog.w - 50 (DAT_000de628 = -50.0),
        // h = 11 (0x41300000).
