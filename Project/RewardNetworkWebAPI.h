/**
 * @file
 * The HTTP request builder and transport for the bundled Konami RewardNetwork
...
/**
 * The reward SDK's HTTP layer: request building, async and sync dispatch, and response
 * post-processing.
 */
...
/**
 * The parameters attached to every request: `{"cr": "0", "format": "json"}`.
...
/**
 * Build a request, merging the parameters with +commonParameters and choosing GET or POST
...
/**
 * Build a GET request, appending the parameters to the URL as a query string.
 * @param url The target URL.
...
/**
 * Build a POST request with an x-www-form-urlencoded body; arrays expand to `key[]=v`.
 * @param url The target URL.
...
/**
 * Post-process a contents-server body.
 *
...
/**
 * Fire a request synchronously, with a small retry and back-off, and parse the response as
 * JSON.
 * @param url The target URL.
 * @param method The HTTP method.
 * @param parameters The request parameters.
...
/**
 * Whether network retry is available; it is only enabled on iOS 6.0 or later.
...
/**
 * The instance initialiser; it zeroes retryCount.
