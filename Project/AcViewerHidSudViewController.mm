...
//  This one edits HID-SUD (four values: OFF, HIDDEN, SUDDEN, HID-SUD). Objective-C++
...
// @ 0x1adf4 — build the list: a transparent, separator-less UITableView; a back button;
...
// @ 0x1b6c8 — after loading, poke the scene manager (populates the pad-display flag).
- (void)viewDidLoad {
    [super viewDidLoad];
...
// @ 0x1b708 — one AcViewerDetailCell per value (reused by "Cell%ld_%ld"), bound to the
// HID-SUD option kind (2) and the row's value label.
...
// @ 0x1b840 — a new value: store it, refresh, play the decide SE and pop back to the
...
// @ 0x1b910 — BACK: (on a real tap) play the cancel SE, refresh the option list behind
