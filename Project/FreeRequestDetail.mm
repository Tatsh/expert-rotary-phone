...
/**
 * The free-request confirm overlay's private layout and request helpers.
 */
@interface FreeRequestDetail ()
/**
 * Draw one clear-count number onto the medal sheet.
...
/** POST the friend request for the shown player. */
