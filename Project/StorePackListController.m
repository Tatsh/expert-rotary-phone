...
// Server error/version-mismatch copy (Ghidra CFStrings; Japanese, glyphs not
// byte-verified): version gate @ cf_POP_NSTORE, generic parse error
// @ 0x... "cf_000000L0zvuW0_0W0_00", download error @ "cf_000k0c_g0M0_0_000".
static NSString *const kVersionMismatchPrefix = @"POP'N STORE ";
static NSString *const kParseErrorMessage = @"通信エラーが発生しました。";
static NSString *const kDownloadErrorMessage = @"通信エラーが発生しました。";
...
- (void)downloaderFinished:(Downloader *)downloader {
    ...
    if (tooOld) {
        NSString *message = [NSString stringWithFormat:@"%@%@", kVersionMismatchPrefix,
                             version ? version : @""];
