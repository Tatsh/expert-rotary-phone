 ...
 * UserSettingData (saveAcvHidSud:) and pops back to the option list.
 *
 * Reconstructed from Ghidra project rb420, program PopnRhythmin (init @ 0x1adf4, viewDidLoad @
 * 0x1b6c8, the table data source and delegate, and touchedBackButton: @ 0x1b910).
 */
