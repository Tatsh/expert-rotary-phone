 ...
 * DownloadMain for the area's visiting friend, and, on completion, animates the map-select flow
 * closed and calls back into the root MainViewController. A left-swipe or the custom back button
 * pops the screen. Reconstructed from Ghidra project rb420, program PopnRhythmin
 * (initWithTreasureData:mapHeadArray:mainMapId: @ 0xc1ea0 and 17 more methods). Built in
 * SubMapSelectViewController.mm, which drives the C++ neSceneManager singleton.
 */
