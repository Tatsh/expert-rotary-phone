/**
 * @file
 * The table header of the iPhone StoreDetailViewController.
 *
...
/**
 * The pack-detail table header: the jacket, name, description and buy button.
 */
@interface StoreDetailHeaderView : UIView

/**
 * The buy or "INSTALLED" button; the detail controller titles it and wires it to
 * -onPurchaseButton:.
 * @return The button.
 */
...
/**
 * Fill the header — the jacket, name and copyright — from a pack.
...
/**
 * Set the pack jacket once its asynchronous download completes.
