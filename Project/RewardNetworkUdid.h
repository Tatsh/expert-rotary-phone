...
//  sharedInstance singleton, keychain storage via SecItem, advertising-id MD5, and
//  the RewardNetwork udid/ad_udid/old_udid plumbing); all of it is reconstructed
//  below as class (+) methods.
//
...
// @ 0xf80e0 — persist `udid` as the "new" (advertising) UDID and remember its index.
