/**
 * @file
 * The scrolling image strip inside a HowToViewCtrl tutorial.
 *
...
/**
 * The paged how-to strip: a row of page images over a shared background.
 */
@interface HowToView : UIView

/**
 * Lay the images side by side, one page wide each, over a background image.
