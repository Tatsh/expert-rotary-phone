...
// initWithFrame: @ 0xdcf5c — super-only override (forwards straight to
// -[UIButton
//   initWithFrame:] with no extra setup), omitted.
// dealloc @ 0xdcf94 — ARC-omitted (super-only; the UIEdgeInsets ivar is a value
// type). setTappableInsets: @ 0xdd11c — synthesized atomic struct setter;
// annotated on the
//   @property in CustomButton.h.
// .cxx_construct @ 0xdd154 — compiler-emitted C++ ivar constructor for the
// UIEdgeInsets
//   ivar; not hand-written.

// @ 0xdcfc0 — hit-test the point against the bounds inset by `tappableInsets`.
