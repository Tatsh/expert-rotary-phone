/**
 * @file
 * The Konami "RewardNetwork" (Applilink) ad-SDK localised-message lookup.
 *
...
/**
 * Looks up the reward SDK's localised strings.
 */
@interface RewardNetworkMessage : NSObject

/**
 * Look up a key in the SDK bundle's localised "Message" table.
