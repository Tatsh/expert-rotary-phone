/**
 * @file
 * The friend detail overlay pushed when a friend-list row is tapped.
 *
...
/**
 * Build the overlay for one friend.
...
/**
 * Fade the overlay in over 0.3 s.
 */
- (void)startOpenAnimation;
/**
 * Fade the overlay out over 0.3 s, then remove it from its superview.
 */
- (void)startCloseAnimation;

/**
 * Whether the overlay is presented; it drives the list controller's tap and back guards.
