...
// Fade the overlay (and its navigation controller view) in / out. Ghidra:
// startOpenAnimation
...
// atomic accessors in the binary (objc_getProperty/objc_setProperty and
// DMB-guarded ivar loads).
@property(retain) UIImage *backGroundImage; // backGroundImage @ 0x1791c ;
