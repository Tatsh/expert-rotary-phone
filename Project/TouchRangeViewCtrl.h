/**
 * @file
 * The "touch range" adjustment sub-screen, pushed from the game settings.
 *
...
/**
 * The note touch-radius setting screen: a slider over a live touch-target preview.
 */
...
/**
 * The slider moved: track its value into the radius.
 * @param sender The slider.
 * @ghidraAddress 0x8aa9c
 */
- (void)sliderValChanged:(id)sender;
/**
 * The reset button: restore the default 68 pt radius.
 * @param sender The tapped button.
 * @ghidraAddress 0x8aad0
 */
- (void)touchedResetButton:(id)sender;
/**
 * The custom back-button action.
 * @ghidraAddress 0x8b16c
 */
- (void)backButtonFunc;

/**
 * Whether a point lies inside the current touch radius.
