...
@property (nonatomic, assign) BOOL isCloseButtonEnable;   // isCloseButtonEnable @ 0x838a4 ; setIsCloseButtonEnable: @ 0x838bc
@property (nonatomic, retain) UIImage *fromNaviBarImage;  // fromNaviBarImage @ 0x8385c ; setFromNaviBarImage: @ 0x83870
@property (nonatomic, retain) UIImage *backGroundImage;   // backGroundImage @ 0x83880 ; setBackGroundImage: @ 0x83894
