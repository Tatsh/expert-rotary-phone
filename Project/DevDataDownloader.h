...
//  (http://dev.apr.konaminet.jp/apr/dev_data[_old]/<title>/<file>), writes it into
//  the app Caches directory (devdata / acvdevdata subtree), and reports success or a
//  formatted error string to its delegate. Thin wrapper around Downloader.
//
...
//    delegate @ 0x8ee00  setDelegate: @ 0x8ee10  isOld @ 0x8ee20  setIsOld: @ 0x8ee38
//
