...
//  pop'n rhythmin
//
//  See ViewUtility.h. Reconstructed from Ghidra project rb420, program PopnRhythmin
//  (+getCommonBannerBg: @ 0x64f2c). The class has no instance methods and no ivars;
//  this single class method is its only real code in the binary.
//
...
+ (UIView *)getCommonBannerBg:(CGRect)frame {
    ...
    inner.frame = CGRectMake(3.0f, 3.0f,
                             frame.size.width - 6.0f, frame.size.height - 6.0f);
