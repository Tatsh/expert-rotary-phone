...
// The (immutable copy of the) task list this manager was created with. @
// 0x426f0
...
// Overall progress (0..1): (currentIndex + currentProgress) / numTasks. @
// 0x420b0
@property(nonatomic, readonly) float overallProgress;

// Create with a list of StoreDownloadTask (each a fileURL + filePath); returns
// nil when `tasks` is nil. The list is copied. @ 0x41fec
