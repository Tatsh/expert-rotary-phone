 ...
 *
 * Reconstructed from Ghidra project rb420, program PopnRhythmin (init @ 0x7d01c, viewDidLoad @
 * 0x7d8f0, the table data source and delegate, and touchedBackButton: @ 0x7db38).
 */
