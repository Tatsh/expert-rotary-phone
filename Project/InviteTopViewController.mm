...
/**
 * The invite top screen's private button actions and animation callbacks.
 */
@interface InviteTopViewController ()
/**
 * The invite button was tapped: share the player's own code.
 * @param sender The tapped button.
 */
- (void)touchedInviteButton:(id)sender;
/**
 * The input button was tapped: push the code-entry screen.
 * @param sender The tapped button.
 */
