...
// Populate the row from an NSValue-wrapped FriendListData. `rank` is the 0-based row index
// (0 == 1st place); `isBestScoreSort` picks the best-score vs. total-score plaque and value.
