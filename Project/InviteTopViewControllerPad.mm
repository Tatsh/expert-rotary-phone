...
/**
 * The iPad invite screen's private actions and request helper.
 */
@interface InviteTopViewControllerPad () <UITextFieldDelegate,
                                          DownloaderDelegate,
                                          CommonAlertViewDelegate>
/**
 * The decide button was tapped: validate the code, then POST it.
...
/** The tweet button was tapped: share the player's own invite code. */
- (void)onTweetButton;
@end
