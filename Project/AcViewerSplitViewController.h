...
//  pop'n rhythmin
//
//  The iPad layout of the arcade (AC) viewer: a floating split panel over a dimmed
//  backdrop — a left column of category/music-name/genre buttons and a right
//  navigation pane that hosts the AcViewerCategoryViewController list. Reconstructed
//  from Ghidra project rb420, program PopnRhythmin (init @ 0x318e8, initForLeftView
//  @ 0x322c4, the shared open/close fade animations, onButtonTouched:/onBackButtonTouched:).
//
