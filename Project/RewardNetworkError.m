...
+ (NSError *)localizedRewardNetworkErrorWithCode:(NSInteger)code userInfo:(NSDictionary *)userInfo {
    ...
    if (g_pRewardErrorMessageDict == nil) {
        ...
        struct {
            ...
            {0x3ea, @"ApplilinkAuthLoginError", @"Failed to log in."},
            ...
            {0x3f7, @"ApplilinkPasteBoardErrorWriteFailed", @"Failed to write paste board data."},
            {0x3f8, @"ApplilinkPasteBoardErrorValidateError", @"Validate error."},
            {0x3f9, @"ApplilinkPasteBoardErrorInvalidKey", @"Invalid paste board key."},
            {0x3fa,
