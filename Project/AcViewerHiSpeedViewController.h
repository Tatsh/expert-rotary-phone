 ...
 *
 * Reconstructed from Ghidra project rb420, program PopnRhythmin (init @ 0x2cbb0, viewDidLoad @
 * 0x2d484, handleGesture: @ 0x2d4b4, the table data source and delegate, and touchedBackButton: @
 * 0x2d738).
 */
