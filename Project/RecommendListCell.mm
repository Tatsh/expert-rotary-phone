...
- (void)setRecommendData:(NSValue *)recommendValue {
    ...
    if (_packImageView == nil) {
        _packImageView = [[UIImageView alloc]
            initWithFrame:CGRectMake(_imgPackX + baseX + 8, 7.0f, 44.0f, 44.0f)];
    ...
    if (_packNameLbl == nil) {
        ...
        _packNameLbl.textColor = [UIColor colorWithRed:93.0f / 255.0f
                                                 green:88.0f / 255.0f
                                                  blue:84.0f / 255.0f
                                                 alpha:1.0f];
    ...
    if (_dateLbl == nil) {
        ...
        _dateLbl.textColor = [UIColor colorWithRed:93.0f / 255.0f
                                             green:88.0f / 255.0f
                                              blue:84.0f / 255.0f
                                             alpha:1.0f];
    ...
    if (_playerNameLbl == nil) {
        ...
        _playerNameLbl.textColor = [UIColor colorWithRed:93.0f / 255.0f
                                                   green:88.0f / 255.0f
                                                    blue:84.0f / 255.0f
                                                   alpha:1.0f];
    ...
    // "NEW" badge — only when this row's date is newer than the last
    // recommend-list view.
    if (_newMarkImgView == nil) {
        ...
        if (lastView != nil && [lastView compare:v.dateString] == NSOrderedAscending) {
            ...
            _newMarkImgView = [[UIImageView alloc]
                initWithFrame:CGRectMake(
                                  baseX + 0xf0, 8.0f, newImg.size.width, newImg.size.height)];
