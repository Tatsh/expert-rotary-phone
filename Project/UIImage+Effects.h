/**
 * @file
 * UIImage image-processing helpers.
 *
...
/**
 * Small redraw effects on UIImage.
 */
@interface UIImage (Effects)

/**
 * Redraw into a new same-size context, optionally reversing the image.
...
/**
 * Draw into a matching bitmap context and halve each RGB channel, leaving alpha intact, to
...
/**
 * Crop out a sub-rectangle by drawing the image, vertically flipped, into a
