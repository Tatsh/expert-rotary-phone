 ...
 * UserSettingData (saveAcvRanMir:) and pops back to the option list.
 *
 * Reconstructed from Ghidra project rb420, program PopnRhythmin (init @ 0xa6c20, viewDidLoad @
 * 0xa74f4, the table data source and delegate, and touchedBackButton: @ 0xa7738).
 */
