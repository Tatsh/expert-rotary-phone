 ...
 * recommend list was viewed. Subview x-offsets shift on iOS 7. Reconstructed from Ghidra project
 * rb420, program PopnRhythmin (initWithStyle:reuseIdentifier: @ 0xbd418, dealloc @ 0xbd518,
 * setRecommendData: @ 0xbd578, imageDownloader:didLoad: @ 0xbe1d0, imageDownloaderDidFail:didLoad:
 * @ 0xbe244).
 */
