 ...
 * is inside the adjustable radius.
 *
 * Reconstructed from Ghidra project rb420, program PopnRhythmin (initWithFilename:touched: @
 * 0x8b20c, dealloc @ 0x8b2c0, drawRect: @ 0x8b324, getImageWidth @ 0x8b364, getImageHeight @
 * 0x8b3a4, isTouched @ 0x8b3e4, setIsTouched: @ 0x8b3fc). It is pure UIKit and Objective-C, so the
 * build lives in TouchRangeView.m.
 */
