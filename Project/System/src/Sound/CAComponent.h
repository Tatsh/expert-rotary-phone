...
public:
    ...
    // Pause / stop-and-clear a single voice, guarded by its generation (a stale
    // play handle is ignored). pauseVoice sets state 3; stopAndClearVoice frees
    // the voice (state 4 + drop the source). Ghidra: caHandlePause @ 0x267b4 /
    // caHandleStopAndClear @ 0x26864.
