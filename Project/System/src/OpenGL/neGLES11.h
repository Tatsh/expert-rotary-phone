...
//  member *names* are assigned from those decoded GL constants (the original C++
//  identifiers are not recoverable), but the ordinal -> GL value mapping is
//  byte-accurate. Table addresses and the decompiled mapper functions are cited
//  inline and in neGLES11.cpp.
//
...
public:
    ...
    // glTexParameter value. Table @ DAT_0012e150 (8 entries); GLValueToTexParamValue
    // (FUN_000138cc) is the reverse map used by getTexParameter.
    enum TexParamValue {
