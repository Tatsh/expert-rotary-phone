...
// [[UIDevice currentDevice] systemVersion] against @"4.0" with
// NSNumericSearch (0x40) and, on iOS >= 4.0, calls
// +[NSPropertyListSerialization propertyListWithData:options:format:error:]
// (options 0 = immutable), else the legacy
...
// array).
// Same iOS-version gate as RhParsePlistDict: iOS >= 4.0 uses
