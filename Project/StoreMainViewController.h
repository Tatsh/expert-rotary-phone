...
/**
 * The store's main pack catalogue: the pack table, the promotion banner, and the purchase,
...
/**
 * Build the catalogue for a tab host.
...
/**
 * Mark that the store is closing, so in-flight callbacks can bail.
 */
- (void)startStoreClose;
/**
 * Whether a modal alert is on screen; it blocks the back button.
 * @return YES while an alert is up.
 */
- (BOOL)isAlertViewShowing;

/**
 * The pack table's "show more" button action: flip the button to a loading title and
...
/**
 * A pack-list fetch returned no packs.
 * @param controller The list controller that fetched it.
 */
...
/**
 * The restore bar-button action: begin restoring previous purchases.
...
/**
 * The promotion banner was tapped.
...
/**
 * The detail-open animation finished.
...
- (void)openDetailAnimStop:(NSString *)animationID
                  finished:(NSNumber *)finished
                   context:(void *)ctx;
/**
 * The detail-open animation started from the promotion banner finished.
 * @param animationID The animation identifier.
 * @param finished Whether the animation ran to completion.
 * @param ctx The animation context.
 */
- (void)openDetailAnimStopFromPromotion:(NSString *)animationID
                               finished:(NSNumber *)finished
                                context:(void *)ctx;
/**
 * The detail-close animation finished.
 * @param animationID The animation identifier.
 * @param finished Whether the animation ran to completion.
 * @param ctx The animation context.
 */
...
/**
 * Refresh the table row for a pack that has just been purchased.
...
/**
 * Queue a pack gathered during a restore.
 * @param packInfo The restored pack.
 */
- (void)addRestorePackInfo:(StorePackInfo *)packInfo;
/**
 * Advance to the next pack awaiting a detail fetch during a restore.
 * @return YES when another pack was started.
 */
- (BOOL)nextRestorePackInfo;
/**
 * Ask the player whether to download every restored pack's musics now.
 */
- (void)askDownloadAllMusics;
/**
 * Download every restored pack's musics.
 */
- (void)restoreDownloadAllMusics;
/**
 * The restore completed with at least one product.
 */
...
/**
 * The restore completed but found nothing to restore.
 */
- (void)restoreNothing;
...
/**
 * An NSURLConnection finished loading.
 * @param connection The finished connection.
 */
- (void)connectionDidFinishLoading:(NSURLConnection *)connection;
/**
 * An NSURLConnection failed.
...
/**
 * The number of pack rows currently in the table.
...
/**
 * Push the phone detail screen for a pack.
 * @param packID The pack to show.
 */
- (void)showDetailViewForPhone:(int)packID;
/**
 * A pack cell or promotion view was selected.
 * @param packView The selected view.
 */
- (void)packViewSelected:(id)packView;
/**
 * The iPad dim cover was tapped; dismiss the detail card.
