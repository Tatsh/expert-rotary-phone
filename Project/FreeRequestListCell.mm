...
//  pop'n rhythmin
//
//  See FreeRequestListCell.h. Reconstructed from Ghidra project rb420, program
//  PopnRhythmin. Objective-C++ for the neSceneManager::isPadDisplay() device
//  check.
//
...
@implementation FreeRequestListCell {
    // Built lazily in setFriendData:rank: and torn down on reuse; each is owned
...
// @ 0xe4b60 — rebuild the row from a FreeRequestDataStruct. Rebuilt on every
...
// dealloc @ 0xe4b34 — ARC-omitted (chains to super only; every subview is owned
