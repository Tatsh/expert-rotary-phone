...
//  device uuid) to the invite endpoint, and a translucent activity spinner while
//  the request is in flight. On success it grants 5 character tickets and marks
//  the code as redeemed (a code may be entered only once). Reconstructed from
//  Ghidra project rb420, program PopnRhythmin (init @ 0xe7cec, startInviteHttp:
//  @ 0xe8b5c). Built in InputKidViewController.mm (Objective-C++: the SE / scene
//  bridge drives the C++ neEngine singletons).
//
...
@interface InputKidViewController : UIViewController
