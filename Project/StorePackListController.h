...
//  pop'n rhythmin
//
//  Fetches and caches the store's song-pack catalogue. It downloads the pack-list
//  JSON, resolves the StoreKit products for any packs it does not yet know, then
//  builds/updates StorePackInfo models and notifies its delegate. Also holds the
...
//    startFetchingPack: @ 0x57888   getPackInfo: @ 0x57a54   addPackInfoFromID: @ 0x57b28
