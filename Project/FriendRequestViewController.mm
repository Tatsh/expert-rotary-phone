...
/**
 * The friend-request screen's private actions and request helper.
 */
@interface FriendRequestViewController () <DownloadMainDelegate>
/**
 * The request button was tapped: send a request to the entered player id.
 * @param sender The tapped button.
 */
- (void)touchedRequestButton:(id)sender;
/**
 * The free-request button was tapped: open the recommended-friend list.
 * @param sender The tapped button.
 */
