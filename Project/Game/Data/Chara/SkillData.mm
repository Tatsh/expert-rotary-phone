...
static const SkillDataStruct kSkillData[kSkillCount] = {
    ...
    {@"【赤い罠に止まるとルーレット消費TPが減る】",
     30}, // 20  [Landing on a red trap lowers roulette TP cost]
    {@"【青い罠に止まるとルーレット消費TPが減る】",
     30}, // 21  [Landing on a blue trap lowers roulette TP cost]
    {@"【緑の罠に止まるとルーレット消費TPが減る】",
     30}, // 22  [Landing on a green trap lowers roulette TP cost]
    {@"【黄色の罠に止まるとルーレット消費TPが減る】",
     30},                        // 23  [Landing on a yellow trap lowers roulette TP cost]
    ...
    {@"【キャラチケットが貰える確率を上げる】",
     80}, // 29  [Raise the chance of earning a character ticket]
};
