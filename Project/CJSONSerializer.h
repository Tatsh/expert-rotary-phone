/**
 * @file
 * The TouchJSON front-end that serializes a Foundation object graph to an NSString of JSON.
 *
...
/**
 * Serializes a Foundation object graph to a JSON NSString, wrapping a CJSONDataSerializer
...
/**
 * Serialize any supported object.
