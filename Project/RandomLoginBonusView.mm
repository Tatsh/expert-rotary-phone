...
//  ARC. (.mm: uses the C++ neEngine bridge for the root scene view / idiom / SE,
//  plus the AudioManager SE engine.)
//
...
- (instancetype)init {
    ...
    if (self) {
        ...
        board.center = CGPointMake(self.frame.size.width * 0.5f,
        ...
        NSArray *up   = @[ [UIImage imageNamed:@"num_logb_0"], [UIImage imageNamed:@"num_logb_1"],
                           [UIImage imageNamed:@"num_logb_2"], [UIImage imageNamed:@"num_logb_3"],
                           [UIImage imageNamed:@"num_logb_4"], [UIImage imageNamed:@"num_logb_5"],
                           [UIImage imageNamed:@"num_logb_6"], [UIImage imageNamed:@"num_logb_7"],
                           [UIImage imageNamed:@"num_logb_8"], [UIImage imageNamed:@"num_logb_9"] ];
        NSArray *down = @[ [UIImage imageNamed:@"num_logb_9"], [UIImage imageNamed:@"num_logb_8"],
                           [UIImage imageNamed:@"num_logb_7"], [UIImage imageNamed:@"num_logb_6"],
                           [UIImage imageNamed:@"num_logb_5"], [UIImage imageNamed:@"num_logb_4"],
                           [UIImage imageNamed:@"num_logb_3"], [UIImage imageNamed:@"num_logb_2"],
                           [UIImage imageNamed:@"num_logb_1"], [UIImage imageNamed:@"num_logb_0"] ];
        NSArray *mid1 = @[ [UIImage imageNamed:@"num_logb_4"], [UIImage imageNamed:@"num_logb_5"],
                           [UIImage imageNamed:@"num_logb_6"], [UIImage imageNamed:@"num_logb_7"],
                           [UIImage imageNamed:@"num_logb_8"], [UIImage imageNamed:@"num_logb_9"],
                           [UIImage imageNamed:@"num_logb_0"], [UIImage imageNamed:@"num_logb_1"],
                           [UIImage imageNamed:@"num_logb_2"], [UIImage imageNamed:@"num_logb_3"] ];
        NSArray *mid2 = @[ [UIImage imageNamed:@"num_logb_3"], [UIImage imageNamed:@"num_logb_2"],
                           [UIImage imageNamed:@"num_logb_1"], [UIImage imageNamed:@"num_logb_0"],
                           [UIImage imageNamed:@"num_logb_9"], [UIImage imageNamed:@"num_logb_8"],
                           [UIImage imageNamed:@"num_logb_7"], [UIImage imageNamed:@"num_logb_6"],
                           [UIImage imageNamed:@"num_logb_5"], [UIImage imageNamed:@"num_logb_4"] ];
        ...
        _numImgView0010 = [self makeDigitReelForValue:((_bonus % 100) / 10)
                                      animationImages:mid1
                                               hidden:NO];
        _numImgView0001 = [self makeDigitReelForValue:(_bonus % 10)
                                      animationImages:mid2
                                               hidden:NO];
...
// Build one rolling digit reel; blank (empty image view) when hiddenLeadingZero.
- (UIImageView *)makeDigitReelForValue:(int)digit
                        animationImages:(NSArray *)images
                                 hidden:(BOOL)hiddenLeadingZero {
    UIImage *face = [UIImage imageNamed:[NSString stringWithFormat:@"num_logb_%d", digit]];
    UIImageView *reel = hiddenLeadingZero
        ? [[UIImageView alloc] init]
        : [[UIImageView alloc] initWithImage:face];
...
- (void)show {
    ...
    [UIView animateWithDuration:0.3
        ...
        // Ghidra completion @ 0x19b1c — start the looping roll SE for the reels.
        self->_seInstId[0] = [[AudioManager sharedManager] playSe:nil resourceId:self->_seRscId[0]];
    }];
}

// @ 0x19b9c — board tap: first lock the reels (state 0), then close (state != 0).
