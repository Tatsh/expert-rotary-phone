/**
 * @file
 * @brief Compatibility shims for the modern Objective-C API names.
 *
 * @newCode
 *
...
/** @brief The pre-iOS 7 spelling of the text-attribute font key. */
#define NSFontAttributeName UITextAttributeFont
/** @brief The pre-iOS 7 spelling of the text-attribute foreground colour key. */
#define NSForegroundColorAttributeName UITextAttributeTextColor
/** @brief The pre-iOS 7 spelling of the text-attribute shadow key. */
#define NSShadowAttributeName UITextAttributeTextShadowColor
#endif

#if !defined(__IPHONE_8_0) || __IPHONE_OS_VERSION_MAX_ALLOWED < __IPHONE_8_0
/** @brief The pre-iOS 8 spelling of the Gregorian calendar identifier. */
#define NSCalendarIdentifierGregorian NSGregorianCalendar
/** @brief The pre-iOS 8 spelling of the always-authorised location status. */
#define kCLAuthorizationStatusAuthorizedAlways kCLAuthorizationStatusAuthorized
/** @brief The pre-iOS 8 spelling of the year calendar unit. */
#define NSCalendarUnitYear NSYearCalendarUnit
/** @brief The pre-iOS 8 spelling of the month calendar unit. */
#define NSCalendarUnitMonth NSMonthCalendarUnit
/** @brief The pre-iOS 8 spelling of the day calendar unit. */
#define NSCalendarUnitDay NSDayCalendarUnit
#endif

#if !defined(__IPHONE_9_0) || __IPHONE_OS_VERSION_MAX_ALLOWED < __IPHONE_9_0
/** @brief The pre-iOS 9 spelling of the spatial-mixer audio-unit subtype. */
