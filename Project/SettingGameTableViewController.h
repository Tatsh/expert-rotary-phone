...
//  A grouped table of three category header rows -- サウンド (Sound), ゲーム演出
//  (Game effects) and ポップ君サイズ (Pop-kun size) -- each of which expands an
//  in-line detail row hosting a dedicated sub-controller's view (SoundSettingView,
//  GameEffectView, PopkunSizeViewCtrl). Reconstructed from Ghidra project rb420,
//  program PopnRhythmin (initWithStyle: @ 0x88b08 and 16 more methods). Built in
