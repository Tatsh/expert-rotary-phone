...
//  pop'n rhythmin
//
//  See PolicyView.h. Reconstructed from Ghidra project rb420, program
//  PopnRhythmin:
//    init                                @ 0x52a04
//    viewDidLoad                         @ 0x52a8c
...
//    0x53030 backButtonFunc @ 0x5303c
...
//
//  Honesty notes:
//   - The agreement body is NOT an embedded CFString: -viewDidLoad loads it
//   from
...
//   - The iPad frame is NEON-spilled: the text view is inset from
//   self.view.frame
//     by +10 on x (0x41200000) and -20 on width (0xc1a00000) — reconstructed
//     from the FloatVectorAdd pair; y/height are the view's own.
...
- (instancetype)init {
    self = [super init];
    if (self != nil) {
        self.view.backgroundColor = [UIColor colorWithRed:0.953f
                                                    green:0.953f
                                                     blue:0.953f
                                                    alpha:1.0f];
    }
