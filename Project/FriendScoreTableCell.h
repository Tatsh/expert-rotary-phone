...
//  pop'n rhythmin
//
//  A friend-score ranking row (order / chara / name / score / rank / full-combo);
//  subview x-offsets shift on iOS 7. Reconstructed from Ghidra project rb420,
//  program PopnRhythmin (initWithStyle:reuseIdentifier: @ 0xae06c).
//
