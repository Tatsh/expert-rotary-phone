...
| Classes audited                        |      173 |
| Complete                               |       54 |
| Partial (file exists, methods missing) |       41 |
| Fully missing (no source file)         |       78 |
| **Missing methods**                    | **1587** |
...
| `neGLView`                     |    6 |    15 |       9 |
| `AcViewerSplitViewController`  |    7 |    15 |       8 |
...
Methods **7/15** · ivars 12 · `instanceSize`=`256`
...
Methods **1/5** · ivars 5 · `instanceSize`=`84`
