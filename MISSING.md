...
reconstructed `@ 0x…` annotations in `Project/`. A method is reconstructed iff its IMP (thumb bit
cleared) appears as a `@`-address in source. Self-updating: regenerate after adding sources.
...
| Fully missing (no source file) | 90 |
| **Missing methods** | **1794** |

## Scope decisions

| Component | Owner | Action |
| --- | --- | --- |
| TouchJSON (`CJSON*`, `CDataScanner`, `CSerializedJSONData`) | ours (no upstream source) | reconstruct (now counted) |
| `RewardNetwork*` / `Recommend*` (Konami ad SDK) | ours | reconstruct (now counted; may stub first) |
| `BFCodec` (Blowfish) | ours | reconstruct (now counted) |
| `UnZipArchive` (ZipArchive) | 3rd-party ([ziparchive](https://code.google.com/archive/p/ziparchive/)) | **exclude**, use upstream |

## Fully missing classes — 90
...
`ArcadeScoreData`, `CharaTicketData`, `DelayImageView`, `FriendListDetail`, `FriendListDetailChara`, `FriendListViewController`, `FriendReplyViewController`, `HowToView`, `OverScoreData`, `ScoreData`, `SettingCustomerTableViewController`, `SettingGameTableViewController`, `SettingHowtoTableViewController`, `StoreUtil`, `TreasureData`, `UserSettingData`, `neTextureForiOS`
...
| `m_LoadedMaster` | `char (BOOL)` | `0xf8` |
| `m_LoadedImages` | `char (BOOL)` | `0xf9` |
| `m_IsAnimationing` | `char (BOOL)` | `0xfa` |
...
| Name | Type | Offset |
| --- | --- | ---: |
| `navigationBarHidden` | `char (BOOL)` | `0x4` |
...
| `m_IsAnimationing` | `char (BOOL)` | `0xb4` |
...
| `_isAninationing` | `char (BOOL)` | `0xc8` |
...
| `_isNavigationBarHidden` | `char (BOOL)` | `0xa8` |
...
| Name | Type | Offset |
| --- | --- | ---: |
| `_isAnimationing` | `char (BOOL)` | `0xa2` |
...
| `_eventViewing` | `char (BOOL)` | `0xf0` |
| `_autoScroll` | `char (BOOL)` | `0xf1` |
...
| `_isAnimationing` | `char (BOOL)` | `0xbc` |
...
| `isIndicator` | `char (BOOL)` | `0x3c` |
| `nowHidden` | `char (BOOL)` | `0x3d` |
| `_viewType` | `int` | `0x40` |
...
| `_isAnimationing` | `char (BOOL)` | `0xcc` |
...
| `m_IsAnimationing` | `char (BOOL)` | `0xb0` |

### `SoundSettingView` — ❌ missing

Methods **0/22** · ivars 8 · `instanceSize`=`196`

#### Missing methods

- `initWithStyle:` — `0x811c8`
- `dealloc` — `0x8131c`
- `viewDidLoad` — `0x81564`
- `didReceiveMemoryWarning` — `0x8191c`
- `viewDidUnload` — `0x81948`
- `viewWillAppear:` — `0x81974`
- `viewDidAppear:` — `0x819a0`
- `viewWillDisappear:` — `0x819cc`
- `viewDidDisappear:` — `0x819f8`
- `shouldAutorotateToInterfaceOrientation:` — `0x81a24`
- `numberOfSectionsInTableView:` — `0x81a30`
- `tableView:numberOfRowsInSection:` — `0x81a60`
- `tableView:cellForRowAtIndexPath:` — `0x81a8c`
...
- `tableView:didSelectRowAtIndexPath:` — `0x82934`
- `bgmSliderValChanged:` — `0x82af4`
- `seSliderValChanged:` — `0x82bbc`
- `touchSoundSliderValChanged:` — `0x82cc4`
- `isHaveTouchSound:` — `0x82d9c`
- `backButtonFunc` — `0x82dc0`
...
| `_forAcMain` | `char (BOOL)` | `0xa8` |
| `_isAnimationing` | `char (BOOL)` | `0xa9` |
...
| `_isAnimationing` | `char (BOOL)` | `0xb0` |
...
| `_isAnimationing` | `char (BOOL)` | `0xb4` |
...
| `_isAnimationing` | `char (BOOL)` | `0x104` |
...
| --- | --- | ---: |
| `_dummyView` | `UIViewController *` | `0xa4` |
| `_isAnimationing` | `char (BOOL)` | `0xa8` |
...
| `_isFailed` | `char (BOOL)` | `0xc4` |
| `_isAnimationing` | `char (BOOL)` | `0xc5` |
| `_tryCnt` | `int` | `0xc8` |
...
| `_isAnimationing` | `char (BOOL)` | `0x3c` |
| `_isEnabled` | `char (BOOL)` | `0x3d` |
...
| `_isAnimationing` | `char (BOOL)` | `0xb0` |
| `_isCloseReserve` | `char (BOOL)` | `0xb1` |

### `GameEffectView` — ❌ missing

Methods **0/11** · ivars 0 · `instanceSize`=`162`

#### Missing methods

- `initWithStyle:` — `0x72d4c`
- `dealloc` — `0x72eb0`
- `viewDidLoad` — `0x72edc`
- `didReceiveMemoryWarning` — `0x730f4`
- `numberOfSectionsInTableView:` — `0x73120`
- `tableView:numberOfRowsInSection:` — `0x73124`
- `tableView:cellForRowAtIndexPath:` — `0x73128`
- `tableView:didSelectRowAtIndexPath:` — `0x73518`
- `tableView:viewForHeaderInSection:` — `0x735dc`
- `tableView:heightForHeaderInSection:` — `0x737b0`
- `backButtonFunc` — `0x737d8`

### `PolicyView` — ❌ missing

Methods **0/11** · ivars 1 · `instanceSize`=`168`
...
| `_isAnimationing` | `char (BOOL)` | `0x60` |
| `_state` | `int` | `0x64` |
...
| Name | Type | Offset |
| --- | --- | ---: |
| `strictEscapeCodes` | `char (BOOL)` | `0x1c` |
...
Methods **0/10** · ivars 12 · `instanceSize`=`224`

#### Missing methods

- `viewDidLoad` — `0x8b44c`
- `didReceiveMemoryWarning` — `0x8c1a4`
- `viewWillDisappear:` — `0x8c1d0`
- `dealloc` — `0x8c1fc`
- `sliderValChanged:` — `0x8c228`
- `sliderValDecide:` — `0x8c270`
- `touchedResetButton:` — `0x8c29c`
- `backButtonFunc` — `0x8c30c`
- `resizePopkun` — `0x8c3a8`
- `.cxx_construct` — `0x8c620`
...
| `m_IsOld` | `char (BOOL)` | `0x10` |
| `m_Delegate` | `<DevDataDownloaderDelegate> *` | `0x14` |
| `isAcv` | `char (BOOL)` | `0x18` |
...
| `_loginCnt` | `int` | `0x18` |
| `_isLoginCntUpdate` | `char (BOOL)` | `0x1c` |
...
| `_isNewMusicPackReleased` | `char (BOOL)` | `0x54` |
...
| `_isGetVisitorSuccess` | `char (BOOL)` | `0xa0` |
...
| `_isTreasureEventInfoUpdated` | `char (BOOL)` | `0xe4` |
| `_isGameEventInfoUpdated` | `char (BOOL)` | `0xe5` |
...
| `m_IsPad` | `char (BOOL)` | `0xec` |
| `m_IsLoadingMoreList` | `char (BOOL)` | `0xed` |
| `m_IsAnimationing` | `char (BOOL)` | `0xee` |
| `m_OffsetForOS` | `int` | `0xf0` |
| `m_IsStoreClosing` | `char (BOOL)` | `0xf4` |
| `_isAlertViewShowing` | `char (BOOL)` | `0xf5` |
...
| `m_MusicDataArrayDirty` | `char (BOOL)` | `0x28` |
| `m_AcMusicDataArray` | `NSMutableArray *` | `0x2c` |
| `m_AcMusicDataArrayDirty` | `char (BOOL)` | `0x30` |
...
| `isPad` | `char (BOOL)` | `0xb8` |
| `_isEffectOn` | `char (BOOL)` | `0xb9` |
...
| `m_Animation` | `char (BOOL)` | `0xb8` |
| `m_IsModalDialogAnimation` | `char (BOOL)` | `0xb9` |
...
| `_isCloseButtonEnable` | `char (BOOL)` | `0xbc` |
...
| Name | Type | Offset |
| --- | --- | ---: |
| `_isAnimationing` | `char (BOOL)` | `0x34` |
...
| `isDownloadingSample` | `char (BOOL)` | `0xd8` |
| `delegate` | `id` | `0xdc` |
...
| `m_Transactioing` | `char (BOOL)` | `0x10` |
| `m_IsRestored` | `char (BOOL)` | `0x11` |
| `m_RestoredTransactions` | `NSMutableArray *` | `0x14` |
| `m_IsMusicData` | `char (BOOL)` | `0x18` |
...
| `m_PacklistContinued` | `char (BOOL)` | `0x28` |
...
| `isOS7` | `char (BOOL)` | `0x48` |
| `isPad` | `char (BOOL)` | `0x49` |
...
| `_isBestScoreSort` | `char (BOOL)` | `0xb4` |
